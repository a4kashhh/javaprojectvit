...
/**
 * Immutable-ish Course value object. Demonstrates Builder pattern and immutability ideas.
 */
public class Course {
    ...
    public String toString(){
        return String.format("Course[%s - %s (%dcr) %s %s]", code, title, credits, semester, department);
    }
